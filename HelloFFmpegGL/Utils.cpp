...
void * Utils::fileContents(const char *filename, GLint *length)
{
...
short Utils::leShort(unsigned char *bytes)
{
	return bytes[0] | ((char)bytes[1] << 8);
}

void *Utils::readTga(const char *filename, int *width, int *height)
{
	struct tga_header
	{
		char  id_length;
